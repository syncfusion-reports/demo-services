...
            {
            ...
            {
                LayoutOption = Syncfusion.Reporting.Writer.WordLayoutOptions.TopLevel,
                ParagraphSpacing = new Syncfusion.Reporting.Writer.ParagraphSpacing()
                {
                    Bottom = 0.5f,
                    Top = 0.5f
                },
            ...
            {
                LayoutOption = Syncfusion.Reporting.Writer.ExcelLayoutOptions.IgnoreCellMerge,
            };
        }
